  ...
  return (
    <section id="services" className="relative py-20 bg-black overflow-hidden">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/4 left1/4 w-96 h-96 bg-primary/20 opacity-20 rounded-full blur-3xl" />
          ...
          {services.slice(0, 2).map((service, index) => {
            ...
            return (
              <FadeIn
                ...
                delay={100 + index * 100}
              >
                <div className="group relative bg-white/5 border border-white/10 rounded-3xl p-8 hover:border-primary/30 transition-all duration-300 h-full min-h-70 flex flex-col">
                  <div className="mb-6">
          ...
          {services.slice(2).map((service, index) => {
            ...
            return (
              <FadeIn
                ...
                delay={100 + index * 100}
              >
                <div className="group relative bg-white/5 border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full">
                  <div className="mb-4">
